...
public class MyService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        // custom layout
        mFloatingView = LayoutInflater.from(this).inflate(R.layout.voice_room_floaticon, null);
...
//        textView.setText(subName);
        ...
        relativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent home = new Intent(MyService.this,MainActivity.class);
                home.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(home);
                Delegate.theMainActivity.onClickFloatingButton();
                if(wm != null) {
                    wm.removeView(mFloatingView);
                }
            }
...
//
            NotificationCompat.Builder builder = new NotificationCompat.Builder(this, MyApplication.CHANNEL_3_ID)
                    ...
                    .setContentTitle("Group conference")
                    .setContentText("Conference running");
                 //   .setContentInfo("Conference running");
