...
class BottomBlockList extends StatefulWidget {
  GroupModel group;
  final String userId;
  final int position;
  final String fromId;
  ...
  BottomBlockList({this.userId, this.group, this.position, this.fromId, this.isHost, this.admin});

  @override
  _BottomBlockListState createState() => _BottomBlockListState();
}

class _BottomBlockListState extends State<BottomBlockList> {
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    GestureDetector(
                                      child: Text("Remove", style: ftwhite14,),
                                      onTap: (){
                                        ...
                                        ChatMethodsBigGroup().messageForJoiningTheGroup(msgText:"Unblocked from group by"
                                            " ${widget.admin.nName}",
                                            receiverId: widget.userId,
                                            name: dt[index]['name'],
                                            photo: dt[index]['photo'],
