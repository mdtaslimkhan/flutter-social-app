...
class ChatNotificationPersonal extends StatelessWidget {

  final UserModel loggedUser;
  final MessageModelPersonal msg;
  ChatNotificationPersonal({
    this.loggedUser,
    this.msg
  });
          ...
          child: Row(
            children: [
              GestureDetector(
                ...
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => Profile(userId: msg.receiverId,currentUser: loggedUser,)));
                },
              ),
              Text(' ${msg.text}',
                style: TextStyle(
