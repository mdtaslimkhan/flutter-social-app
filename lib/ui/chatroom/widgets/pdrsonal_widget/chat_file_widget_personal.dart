...
class ChatFileWidgetPersonal extends StatefulWidget {
  ...
  @override
  State<ChatFileWidgetPersonal> createState() => _ChatFileWidgetPersonalState();
}

class _ChatFileWidgetPersonalState extends State<ChatFileWidgetPersonal> {
