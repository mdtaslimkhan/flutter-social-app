...
class AddressEdit extends StatefulWidget {
  ...
  String userId;
  String address;
  AddressEdit({this.userId,this.address});
...
class _AddressEditState extends State<AddressEdit> {
  ...
  Future update({String userId, String occupation}) async {
    ...
    final String url = BaseUrl.baseUrl("updateAddress");
    ...
    String email = data['user']['address'];
  ...
  Widget build(BuildContext context) {
    ctrName.text = widget.address;
    return LoadingImage(
      inAsyncCall: showProgress,
      child: SafeArea(
        child: Scaffold(
          appBar: AppBar(title: Text("Address edit")),
          body: Form(
            key: _globalKey,
            child: Column(
