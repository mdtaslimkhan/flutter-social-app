...
class GroupNameEdit extends StatefulWidget {

  String name;
  String id;
  GroupNameEdit({this.id,this.name});

  @override
  _GroupNameEditState createState() => _GroupNameEditState();
}

class _GroupNameEditState extends State<GroupNameEdit> {
  ...
  Widget build(BuildContext context) {
    ...
    return LoadingImage(
      ...
      child: SafeArea(
        child: Scaffold(
          appBar: AppBar(title: Text("Group Name edit")),
          body: Form(
            key: _globalKey,
            child: Column(
                ...
                GestureDetector(
                  ...
                  onTap: () async {
                    ...
                    if(_globalKey.currentState.validate()){
                     ...
                     var isUpdated = await _groupFunctions.updateGroup(groupId: widget.id, text: fnm, field: "name");
                      if(isUpdated){
                        setState(() {
                          showProgress = false;
                        });
