...
class GroupLanguageEdit extends StatefulWidget {

  String name;
  String id;
  GroupLanguageEdit({this.id,this.name});

  @override
  _GroupLanguageEditState createState() => _GroupLanguageEditState();
}

class _GroupLanguageEditState extends State<GroupLanguageEdit> {
  ...
  Widget build(BuildContext context) {
    ...
    return LoadingImage(
      ...
      child: SafeArea(
        child: Scaffold(
          appBar: AppBar(title: Text("Group language edit")),
          body: Form(
            key: _globalKey,
            child: Column(
                ...
                GestureDetector(
                  ...
                  onTap: () async {
                    ...
                    if(_globalKey.currentState.validate()){
                     ...
                     var isUpdated = await _groupFunctions.updateGroup(groupId: widget.id, text: fnm, field: "language");
                      if(isUpdated){
                        setState(() {
                          showProgress = false;
                        });
