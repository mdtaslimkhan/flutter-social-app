...
class GroupAnnounceEdit extends StatefulWidget {

  String name;
  String id;
  GroupAnnounceEdit({this.id,this.name});

  @override
  _GroupAnnounceEditState createState() => _GroupAnnounceEditState();
}

class _GroupAnnounceEditState extends State<GroupAnnounceEdit> {
  ...
  Widget build(BuildContext context) {
    ...
    return LoadingImage(
      ...
      child: SafeArea(
        child: Scaffold(
          appBar: AppBar(title: Text("Group announcement")),
          body: Form(
            key: _globalKey,
            child: Column(
                ...
                GestureDetector(
                  ...
                  onTap: () async {
                    ...
                    if(_globalKey.currentState.validate()){
                     ...
                     var isUpdated = await _groupFunctions.updateGroup(groupId: widget.id, text: fnm, field: "announce");
                      if(isUpdated){
                        setState(() {
                          showProgress = false;
                        });
