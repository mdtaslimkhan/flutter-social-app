...
class GroupTagEdit extends StatefulWidget {

  String name;
  String id;
  GroupTagEdit({this.id,this.name});

  @override
  _GroupTagEditState createState() => _GroupTagEditState();
}

class _GroupTagEditState extends State<GroupTagEdit> {
  ...
  Widget build(BuildContext context) {
    ...
    return LoadingImage(
      ...
      child: SafeArea(
        child: Scaffold(
          appBar: AppBar(title: Text("Group tag edit")),
          body: Form(
            key: _globalKey,
            child: Column(
                ...
                GestureDetector(
                  ...
                  onTap: () async {
                    ...
                    if(_globalKey.currentState.validate()){
                     ...
                     var isUpdated = await _groupFunctions.updateGroup(groupId: widget.id, text: fnm, field: "tag");
                      if(isUpdated){
                        setState(() {
                          showProgress = false;
                        });
