...
class GroupNickNameEdit extends StatefulWidget {

  String name;
  String id;
  GroupNickNameEdit({this.id,this.name});

  @override
  _GroupNickNameEditState createState() => _GroupNickNameEditState();
}

class _GroupNickNameEditState extends State<GroupNickNameEdit> {
  ...
  Widget build(BuildContext context) {
    ...
    return LoadingImage(
      ...
      child: SafeArea(
        child: Scaffold(
          appBar: AppBar(title: Text("Group nickname edit")),
          body: Form(
            key: _globalKey,
            child: Column(
                ...
                GestureDetector(
                  ...
                  onTap: () async {
                    ...
                    if(_globalKey.currentState.validate()){
                     ...
                     var isUpdated = await _groupFunctions.updateGroup(groupId: widget.id, text: fnm, field: "nick_name");
                      if(isUpdated){
                        setState(() {
                          showProgress = false;
                        });
