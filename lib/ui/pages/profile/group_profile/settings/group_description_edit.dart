...
class GroupDescripEdit extends StatefulWidget {

  String name;
  String id;
  GroupDescripEdit({this.id,this.name});

  @override
  _GroupDescripEditState createState() => _GroupDescripEditState();
}

class _GroupDescripEditState extends State<GroupDescripEdit> {
  ...
  Widget build(BuildContext context) {
    ...
    return LoadingImage(
      ...
      child: SafeArea(
        child: Scaffold(
          appBar: AppBar(title: Text("Group description edit")),
          body: Form(
            key: _globalKey,
            child: Column(
                ...
                GestureDetector(
                  ...
                  onTap: () async {
                    ...
                    if(_globalKey.currentState.validate()){
                     ...
                     var isUpdated = await _groupFunctions.updateGroup(groupId: widget.id, text: fnm, field: "description");
                      if(isUpdated){
                        setState(() {
                          showProgress = false;
                        });
