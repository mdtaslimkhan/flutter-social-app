...
class GroupRules4Edit extends StatefulWidget {

  String name;
  String id;
  GroupRules4Edit({this.id,this.name});

  @override
  _GroupRules4EditState createState() => _GroupRules4EditState();
}

class _GroupRules4EditState extends State<GroupRules4Edit> {
  ...
  Widget build(BuildContext context) {
    ...
    return LoadingImage(
      ...
      child: SafeArea(
        child: Scaffold(
          appBar: AppBar(title: Text("Group rules 4 edit")),
          body: Form(
            key: _globalKey,
            child: Column(
                ...
                GestureDetector(
                  ...
                  onTap: () async {
                    ...
                    if(_globalKey.currentState.validate()){
                     ...
                     var isUpdated = await _groupFunctions.updateGroup(groupId: widget.id, text: fnm, field: "rules_4");
                      if(isUpdated){
                        setState(() {
                          showProgress = false;
                        });
