...
class GroupRules1Edit extends StatefulWidget {

  String name;
  String id;
  GroupRules1Edit({this.id,this.name});

  @override
  _GroupRules1EditState createState() => _GroupRules1EditState();
}

class _GroupRules1EditState extends State<GroupRules1Edit> {
  ...
  Widget build(BuildContext context) {
    ...
    return LoadingImage(
      ...
      child: SafeArea(
        child: Scaffold(
          appBar: AppBar(title: Text("Group rules 1 edit")),
          body: Form(
            key: _globalKey,
            child: Column(
                ...
                GestureDetector(
                  ...
                  onTap: () async {
                    ...
                    if(_globalKey.currentState.validate()){
                     ...
                     var isUpdated = await _groupFunctions.updateGroup(groupId: widget.id, text: fnm, field: "rules_1");
                      if(isUpdated){
                        setState(() {
                          showProgress = false;
                        });
