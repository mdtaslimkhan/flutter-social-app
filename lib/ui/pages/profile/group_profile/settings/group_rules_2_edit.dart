...
class GroupRules2Edit extends StatefulWidget {

  String name;
  String id;
  GroupRules2Edit({this.id,this.name});

  @override
  _GroupRules2EditState createState() => _GroupRules2EditState();
}

class _GroupRules2EditState extends State<GroupRules2Edit> {
  ...
  Widget build(BuildContext context) {
    ...
    return LoadingImage(
      ...
      child: SafeArea(
        child: Scaffold(
          appBar: AppBar(title: Text("Group rules 2 edit")),
          body: Form(
            key: _globalKey,
            child: Column(
                ...
                GestureDetector(
                  ...
                  onTap: () async {
                    ...
                    if(_globalKey.currentState.validate()){
                     ...
                     var isUpdated = await _groupFunctions.updateGroup(groupId: widget.id, text: fnm, field: "rules_2");
                      if(isUpdated){
                        setState(() {
                          showProgress = false;
                        });
