...
class GroupRules3Edit extends StatefulWidget {

  String name;
  String id;
  GroupRules3Edit({this.id,this.name});

  @override
  _GroupRules3EditState createState() => _GroupRules3EditState();
}

class _GroupRules3EditState extends State<GroupRules3Edit> {
  ...
  Widget build(BuildContext context) {
    ...
    return LoadingImage(
      ...
      child: SafeArea(
        child: Scaffold(
          appBar: AppBar(title: Text("Group rules 3 edit")),
          body: Form(
            key: _globalKey,
            child: Column(
                ...
                GestureDetector(
                  ...
                  onTap: () async {
                    ...
                    if(_globalKey.currentState.validate()){
                     ...
                     var isUpdated = await _groupFunctions.updateGroup(groupId: widget.id, text: fnm, field: "rules_3");
                      if(isUpdated){
                        setState(() {
                          showProgress = false;
                        });
